...
def generator(input_nc, output_nc, gpu_ids=[]):
    """Create a generator
    ...
    net = UNet(input_channels=input_nc, output_channels=output_nc)
...
class UNet(nn.Module):
    def __init__(self, input_channels=1, output_channels=1, freeze_bn=False):
        super().__init__()
